...
void main() {
  group('MoinsenSupabaseGenCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late MoinsenSupabaseGenCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = MoinsenSupabaseGenCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = MoinsenSupabaseGenCommandRunner();
